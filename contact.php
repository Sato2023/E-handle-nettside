    ...
    <body>
        ...
        <section class="contact_form">
            <form method="post" action="contactinfo.php">
                ...
                <input type="text" id="order" name="order" placeholder="12345678">

                <textarea name="text" id="subject" name="subject" placeholder="Type your message here..."cols="30" rows="10"></textarea>
