...
<html>
    <head>
    <meta charset="UTF-8">
        <title>Orginal Collentions</title>
    ...
    <body>
        ...
        <section class="slideshow_collection"> 
            <section class="slide_bilder">
                <img src="nettsideBilder/originalcollection.jpg" style="width:100%">
            </section>
            
            <section class="slide_bilder">
                <img src="nettsideBilder/originalcollection2.jpg" style="width:100%">
            </section>  
        </section>
            <br>
        ...
        <h1 class="page_title">Original Collection</h1>
        <section class="view">
            <?php
                include "get_shop_items.php";
            ?>
        </section>   
        ...
        <script>
            ...
            function slideshow() {
            let i;
            let slides = document.getElementsByClassName("slide_bilder");
            let punkter = document.getElementsByClassName("dot");
            ...
            punkter[slideIndex-1].className += " active";
